...
<html class="fixed">
	<head>
		...
		<link rel="stylesheet" href="{{asset('admin/bootstrap-datepicker/css/datepicker3.css')}}" />

		<!-- Specific Page Vendor CSS -->
		<link rel="stylesheet" href="{{asset('admin/jquery-ui/css/ui-lightness/jquery-ui-1.10.4.custom.css')}}" />
		<link rel="stylesheet" href="{{ asset('admin/bootstrap-multiselect/bootstrap-multiselect.css') }}" />
		...
		<!-- Head Libs -->
		<script src="{{ asset('admin/js/modernizr/modernizr.js') }}"></script>
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
												<img src="{{asset('admin/images/divash_dai.jpg')}}" alt="Joseph Doe Junior" class="img-circle" />
												</figure>
												<span class="title">Sudip Adhikari</span>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							...
							<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@JSOFT.com">
								<span class="name"> {{ Session::get('name') }}</span></span>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li>
									<a role="menuitem" tabindex="-1" href="#" data-lock-screen="true" onclick="event.preventDefault();><i class="fa fa-lock"></i> Lock Screen</a>
								</li>
								<li>
									...
									<section class="panel panel-group">
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												...
												<img src="{{asset('admin/image/divash_dai.jpg')}}">
												</div>
												<div class="profile-info">
													<h4 class="name text-semibold">Divash Acharya</h4>
	...
	<script src="{{asset('admin/jquery-browser-mobile/jquery.browser.mobile.js')}}"></script>
	<script src="{{asset('admin/bootstrap/js/bootstrap.js')}}"></script>
	<script src="{{asset('admin/nanoscroller/nanoscroller.js')}}"></script>
	<script src="{{asset('admin/bootstrap-datepicker/js/bootstrap-datepicker.js')}}"></script>
	<script src="{{asset('admin/magnific-popup/magnific-popup.js')}}"></script>
	<script src="{{asset('admin/jquery-placeholder/jquery.placeholder.js')}}"></script>
		
		<!-- Specific Page Vendor -->
	<script src="{{asset('admin/jquery-ui/js/jquery-ui-1.10.4.custom.js')}}"></script>
	<script src="{{asset('admin/jquery-ui-touch-punch/jquery.ui.touch-punch.js')}}"></script>
	<script src="{{asset('admin/jquery-appear/jquery.appear.js')}}"></script>
	<script src="{{asset('admin/bootstrap-multiselect/bootstrap-multiselect.js')}}"></script>
	<script src="{{asset('admin/jquery-easypiechart/jquery.easypiechart.js')}}"></script>
	<script src="{{asset('admin/flot/jquery.flot.js')}}"></script>
	<script src="{{asset('admin/flot-tooltip/jquery.flot.tooltip.js')}}"></script>
	<script src="{{asset('admin/flot/jquery.flot.pie.js')}}"></script>
	<script src="{{asset('admin/flot/jquery.flot.categories.js')}}"></script>
	<script src="{{asset('admin/flot/jquery.flot.resize.js')}}"></script>
	<script src="{{asset('admin/jquery-sparkline/jquery.sparkline.js')}}"></script>
	<script src="{{asset('admin/raphael/raphael.js')}}"></script>
	<script src="{{asset('admin/morris/morris.js')}}"></script>
	<script src="{{asset('admin/gauge/gauge.js')}}"></script>
	<script src="{{asset('admin/snap-svg/snap.svg.js')}}"></script>
	<script src="{{asset('admin/liquid-meter/liquid.meter.js')}}"></script>
	<script src="{{asset('admin/jqvmap/jquery.vmap.js')}}"></script>
	<script src="{{asset('admin/jqvmap/data/jquery.vmap.sampledata.js')}}"></script>
	<script src="{{asset('admin/jqvmap/maps/jquery.vmap.world.js')}}"></script>
	<script src="{{asset('admin/jqvmap/maps/continents/jquery.vmap.africa.js')}}"></script>
	<script src="{{asset('admin/jqvmap/maps/continents/jquery.vmap.asia.js')}}"></script>
	<script src="{{asset('admin/jqvmap/maps/continents/jquery.vmap.australia.js')}}"></script>
	<script src="{{asset('admin/jqvmap/maps/continents/jquery.vmap.europe.js')}}"></script>
	<script src="{{asset('admin/jqvmap/maps/continents/jquery.vmap.north-america.js')}}"></script>
	<script src="{{asset('admin/jqvmap/maps/continents/jquery.vmap.south-america.js')}}"></script>
