...
<html class="fixed">
	...
	<link rel="stylesheet" href="{{asset('admin/css/theme-custom.css')}}">
		...
		<!-- Head Libs -->
	<script src="{{asset('admin/modernizr/modernizr.js')}}"></script>
	...
	<body>
		...
		<section class="body-sign">
			...
			<a href="{{url('/adminDashboard')}}" class="logo pull-left">
					<img src="admin/image/divash_dai.jpg" height="54" alt="Porto Admin" />
				</a>
