...
<body>
    ...
    <form action="{{url("updateEvent/$event->id")}}" method="post" enctype="multipart/form-data" id="eventForm" >
                {{ csrf_field() }}
                    <div class="form-group" >
                        <label for="eventTitle">Event Title*</label>
                    <input type="text" class="form-control" id="eventTitle" name="eventTitle" placeholder="Give it a short distinct name" value="{{$event->event_title}}">
                    </div>
                    
                    <div class="form-row">
                        <div class="form-group col-md-8">
                            <label for="location">Location*</label>
                        <input type="text" class="form-control" id="inputTitle" name="location"  aria-describedby="venueHelp" placeholder="Enter the venue or location name" value="{{ $event->location_name }}">
                ...
                {{--Start of location field  --}}
                    <div id="location">
                            <div class="form-row">
                                    <div class="form-group col-md-8">
                                    <input type="text" class="form-control" id="inputVenue" name="address"  placeholder="Address" value="{{$event->address}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">        
                                        <div class="form-group col-md-8">
                                        <input type="text" class="form-control" id="inputVenue1" name="address2" placeholder="Address 2" value="{{ $event->address2}}">
                                        </div>
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                <input type="text" class="form-control" id="zipCode"  name="zipCode" placeholder="Zip/Postal Code" value="{{$event->zip_code}}">
                                </div>
                            </div>
                    ...
                    <div class="form-row">
                            <div class="form-group col-md-8">
                                <label for="How often does this event occurs?">How often does this event occurs?</label>
                                    ...
                                    <option selected>{{$event->event_frequency}}</option>
                        ...
                        <div class="form-row">        
                                ...
                                <input type="date" class="form-control" id="theDate" name="date" value="{{ $event->date }}">
                                </div>
                            </div>   
                   ...
                   <div class="form-row">
                       <div class="form-group col-md-4">
                            ...
                            <select class="browser-default custom-select custom-select mb-3" id="from" name="from" >
                                    <option selected>{{$event->from}}</option>
                        ...
                        <div class="form-group col-md-4">   
                            ...
                            <select class="browser-default custom-select custom-select mb-3" id="to" name="to" >
                                    <option selected>{{$event->to}}</option>
                                    @for($hours=0; $hours<12; $hours++) // the interval for hours is '1'
                                        @for($mins=0; $mins<60; $mins+=30)  // the interval for mins is '30'
        ...
        {{-- end of jumbotron --}}
         ...
         <textarea name="eventDescription" id="eventDescription">{{$event->event_description}}</textarea>
         </div>

         <div class="form-row">
            <div class="form-group col-md-8">
                <h4>Organizer Name</h4>  
            <input type="text" class="form-control" name="organizerName" id="organizerName" placeholder="Who is organizing this event?" value="{{$event->organizer_name}}"> 
           </div>
        </div>

        <div class="form-group">
            <h4>Organizer Description</h4>
            <textarea name="organizertDescription" id="organizerDescription">{{$event->organizer_description}}</textarea>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9 formBtnCenter">
               <h4 class="eventTicketType">What type of ticket would you like to choose?</h4>
                <div class="formBtnHolder" id="formBtnHolder">
                ...
                <table class="table table-borderless" >
                    ...
                    <tr>
                        ...
                        <th>Actions</th>
                            ...
                            <tbody>
                            <tr>
                            <td><input type="text" class="form-control" name="ticketName" id="ticketName" placeholder="Give your ticket a name" value="{{$event->ticket_name}}"></td>
                                    <td><input type="text" class="form-control" name="ticketQuantity" id="quantity" placeholder="Quantity" value="{{$event->ticket_quantity}}"></td>
                                    <td><input type="text" class="form-control" name="ticketPrice" id="ticketPrice" placeholder="Ticket price" value="{{$event->price}}"></td>
                                    <input type="hidden" name="ticketType" id="ticketType" value="{{$event->ticket_type}}">
                                    <td>
        ...
        <div class="setting" id="setting">
            ...
            <textarea name="ticketDescription" id="ticketDescription" class="form-control" placeholder="Tell your ticket buyers more about this ticket type">{{$event->ticket_description}}</textarea>
            </div>
            <div class="form-group col-md-6" >
                <h5>Sales Chanel</h5>
                <select class="browser-default custom-select custom-select mb-3" name="salesChanel" id="salesChanel">
                <option selected>{{$event->sales_chanel}}</option>
            ...
            <div class="form-row">
                    <div class="col-md-3">
                    <input type="date" class="form-control" id="theDate" name="salesStartDate" value="{{$event->sales_start_date}}">
                    </div>
                    <div class="col-md-3">
                            <select class="browser-default custom-select custom-select mb-3" name="salesStartTime" id="salesStartTime">
                            <option selected>{{$event->sales_start_time}}</option>
            ...
            <div class="form-row">
                <div class="col-md-3">
                <input type="date" class="form-control" id="theDate" name="salesEndDate" value="{{$event->sales_end_date}}">
                </div>
              

            <div class="col-md-3">
                    <select class="browser-default custom-select custom-select mb-3" name="salesEndTime" id="salesEndTime">
                        <option selected>{{$event->sales_end_time}}</option>
                        <option value="12:00 AM">12:00 AM</option>
                        <option value="12:30 AM">12:30 AM</option>
                        <option value="01:00 AM">01:00 AM</option>
                        <option value="01:30 AM">01:30 AM</option>
        ...
        {{-- End of create ticket field --}}
          ...
          <div class="row">
              ...
              <div class="col-md-8 form-group">
                    ...
                    <option selected value="{{$event->event_type}}">{{\App\Http\Controllers\PagesController:: get_event_type($event->event_type)}}</option>
          ...
          <div class="row">
            ...
            <input type="submit" value="Update Event" name="submit" id="btnSubmit" class="btn btn-success">
        </form>
