...
class AdminController extends Controller
{
    ...
    {
        // $name = Auth::user()->name;->with('name',$name)
    ...
    {
        $event = \App\EventRegistration::find($id);
        $dataValue = true;
        $datas=Country::all();
        $event_datas=EventType::all(); 
        $event_topics = EventTopic::all();
        return view('admin.editEvent')->with(['event'=>$event,'dataValue'=>$dataValue,'datas'=>$datas,'event_datas'=>$event_datas,"event_topics"=>$event_topics]);
    ...
    public function update(Request $request, $id)
    {
       ...
       // update event registration
                $eventRegister =  \App\EventRegistration::find($id);
    ...
    {
       $post =  \App\EventRegistration::find($id);
       $post->delete();

       return redirect('/adminDashboard')->with('success',"Event Deleted Successfully");
    }
    ...
    public function uploadEvent($id){
        ...
        return redirect('/adminDashboard')->with('success',"Event uploaded Successfully");
